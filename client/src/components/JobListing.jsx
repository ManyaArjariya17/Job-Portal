...
const JobListing = () => {
   ...
   useEffect(()=>{
    ...
    const matchesTitle = job => searchFilter.length === 0 || job.title.toLowerCase().includes(searchFilter.title.toLowerCase())

    const matchesSearchLocation = job => searchFilter.location === 0 || job.location.toLowerCase().includes(searchFilter.location.toLowerCase())
